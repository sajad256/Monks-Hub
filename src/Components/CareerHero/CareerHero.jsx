    ...
    <>
      ...
      <div className="flex justify-center w-full mt-20">
        <div className="w-full max-w-[1280px]">
          <div className="info lg:flex lg:justify-between lg:w-11/12">
            ...
            <div className="btn mt-4 md:ms-32">
              <button className="group flex items-center gap-3 border px-3 py-2 rounded-full lg:w-52 bg-[#009D77] text-white font-bold hover:bg-black duration-500">
                View All Blogs
          ...
          {/* Cards Layout */}
          <div className="container mt-10 md:justify-items-center">
