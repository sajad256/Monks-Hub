...
export default function IndustryTalent() {
  return (
    <>
      <section className="bg-[#011813] mt-20 py-20 xl:py-32">
        {/* Information */}
        <div className="flex justify-center w-full">
          <div className="container w-full max-w-[1280px] lg:flex lg:items-center lg:justify-between xl:pt-12 lg:pt-12">
            <h1 className="text-white font-bold text-4xl xl:text-5xl lg:w-6/12 xl:w-6/12">
        ...
        {/* Main div For Cards */}
        <div className="flex justify-center w-full">
          <div className="Main-for-Cards container w-full max-w-[1280px] lg:grid lg:grid-cols-2 xl:grid-cols-4 lg:mt-20 xl:mt-20">
